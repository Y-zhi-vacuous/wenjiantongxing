  ...
  if (essay.status === 'grading') {
    return (
      <div className="flex flex-col items-center justify-center py-24 gap-4">
        ...
        <p className="text-sm text-apple-secondary">预计需要 10-30 秒</p>
      </div>
    )
  }
  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <div className="bg-white rounded-apple shadow-apple p-8 text-center">
        ...
        <div className="text-sm text-apple-secondary mt-1">满分 50</div>
      ...
      {report.basic_errors && (
        <div className="bg-white rounded-apple shadow-apple p-6">
          ...
          <div className="flex gap-4">
            <div className="flex-1 bg-red-50 rounded-apple-sm p-4 text-center">
            ...
            <div className="flex-1 bg-orange-50 rounded-apple-sm p-4 text-center">
            ...
            <div className="flex-1 bg-green-50 rounded-apple-sm p-4 text-center">
        ...
        <div className="bg-white rounded-apple shadow-apple p-6">
          ...
          <div className="space-y-3">
            {report.paragraph_reviews.map((review, i) => (
              <div key={i} className="bg-apple-bg rounded-apple-sm p-5 border-l-4 border-apple-accent">
        ...
        <div className="bg-white rounded-apple shadow-apple p-6">
          ...
          <div className="space-y-3">
            {report.suggestions.map((s, i) => (
              <div key={i} className="flex items-start gap-3 bg-apple-bg rounded-apple-sm p-4">
      ...
      <div className="text-center pt-6">
        <Link
          to="/student/write"
          className="inline-flex items-center gap-2 px-6 py-3 bg-apple-accent text-white rounded-apple-xs font-medium hover:bg-blue-600 transition-all"
        >
